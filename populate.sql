...
insert into anomalia(a_zona, a_imagem, a_lingua, a_ts, a_descricao, a_tem_anomalia_redacao)
	values ('0034, 0012', 'cartaz.jpg', 'pt', '2019-11-10 05:43:22', 'Cartaz com erro', false);
insert into anomalia(a_zona, a_imagem, a_lingua, a_ts, a_descricao, a_tem_anomalia_redacao)
	values ('0012, 0054', 'poster.png', 'eng', '2019-01-15 12:50:56', 'Mal traduzido', false);
insert into anomalia(a_zona, a_imagem, a_lingua, a_ts, a_descricao, a_tem_anomalia_redacao)
	values ('0004, 0006', 'trad.jpg', 'fr', '2019-12-16 14:02:06', 'Mal traduzido', false);
insert into anomalia(a_zona, a_imagem, a_lingua, a_ts, a_descricao, a_tem_anomalia_redacao)
	values ('0010, 0078', 'publicidade.jpg', 'pt', '2019-12-18 16:45:25', 'Erro ortográfico', false);
insert into anomalia(a_zona, a_imagem, a_lingua, a_ts, a_descricao, a_tem_anomalia_redacao)
	values ('0003, 0059', 'frase.png', 'pt', '2019-12-20 08:25:26', 'Frase sem sentido', false);
insert into anomalia(a_zona, a_imagem, a_lingua, a_ts, a_descricao, a_tem_anomalia_redacao)
	values ('0007, 0038', 'foto.jpg', 'pt', '2019-01-01 10:00:00', 'Frase', false);
...
insert into proposta_correcao(pc_nro, pc_data_hora, pc_texto, u_email) values (2, '2017-02-18 02:40:01', 'Alterar para amarelo' , 'nikoletta@gmail.com');
...
insert into correcao(u_email, pc_nro, a_id) values ('nikoletta@gmail.com', 2, 2);
