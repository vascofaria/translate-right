		...
		try {
            ...
            echo("<tbody>");
              foreach($result as $row) {
                ...
                echo("<td><input type='text' name='newEmail'>{$row['u_email']}</td>");
                echo("<td><input type='text' name='newPcNro'>{$row['pc_nro']}</td>");
                echo("<td><input type='text' name='newAId'>{$row['a_id']}</td>");
                echo("<td>
